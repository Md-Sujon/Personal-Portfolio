        ...
        <div className="row project justify-content-center bg-dark">
            ...
            <div className="col-md-3 card card-1 m-3">
                  ...
                  <p className="mt-3"><small>Feeling lonely? Break Your Loneliness Using Python
                    ...
                    <a href="https://medium.com/programminghero/feeling-lonely-break-your-loneliness-using-python-5ea5e2381d98" rel="noreferrer" target="blank" className="m-2 click btn btn-primary">
            ...
            <img className="mt-2" src={image1} alt=""/>
                  <p className="mt-3"><small>10 Python Libraries That Every Python Developer Should Learn To Boost Their Career
                    ...
                    <a href="https://medium.com/programminghero/10-python-libraries-that-every-python-developer-should-learn-to-boost-their-career-649881f3a013" rel="noreferrer" target="blank" className="m-2 click btn btn-primary">
                <i className="fas fa-download">&nbsp;</i>See More</a>
                </div>
            ...
            <img className="mt-2" src={image} alt=""/>
                  <p className="mt-3"><small>Wanna be a JavaScript Ninja, check out these 12 tips and tricks. These will make you super smart and the best developer in your team.</small></p>
                    ...
                    <a href="https://medium.com/programminghero/12-tricks-for-new-javascript-developers-234b1a34239d" rel="noreferrer" target="blank" className=" m-2 click btn btn-primary">
                <i className="fas fa-download">&nbsp;</i>See More</a>
               </div>
