    ...
    return (
        <div className="row project justify-content-center bg-dark">
            ...
            <div className="col-md-3 card card-1 m-3">
                  ...
                  <a href="https://stupefied-albattani-b2a4d3.netlify.app/" rel="noreferrer" target="blank" className="m-2 click btn btn-primary">
                <i className="fas fa-download">&nbsp;</i>Live</a>
                
                
                    <a href="https://github.com/Md-Sujon/Argentina-national-Football-Team" rel="noreferrer" target="blank" className="m-2 click btn btn-primary">
            ...
            <img src={image1} alt=""/>
                  ...
                  • Admin Panel work(Add New Product, Delete Product)
                   ...
                   <a href="https://alifaonline-shop.web.app/" rel="noreferrer" target="blank" className="m-2 click btn btn-primary">
                <i className="fas fa-download">&nbsp;</i>Live</a>
                
                
                    <a href="https://cutt.ly/nbjeLR0" rel="noreferrer" target="blank" className="m-2 click btn btn-primary">
                <i className="fas fa-download">&nbsp;</i>Code</a>
                </div>
            ...
            <img src={image2} alt=""/>
                 ...
                 <a href="https://computer-bangladesh.web.app/" rel="noreferrer" target="blank" className="m-2 click btn btn-primary">
                <i className="fas fa-download">&nbsp;</i>Live</a>
                
                
                    <a href="https://github.com/Md-Sujon/Computer-Bangladesh" rel="noreferrer" target="blank" className=" m-2 click btn btn-primary">
                <i className="fas fa-download">&nbsp;</i>Code</a>
               </div>
